...
Source0  : https://files.pythonhosted.org/packages/1a/6b/9b6b8284e88105acbcb39e71bd3bfcaffcd36c2601152ae23b00e6e04d91/regex-2022.6.2.tar.gz
...
%prep
%setup -q -n regex-2022.6.2
cd %{_builddir}/regex-2022.6.2
pushd ..
cp -a regex-2022.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654269963
...
cp %{_builddir}/regex-2022.6.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-regex/692d7ee2ea91449bb8354092cedb2fd1f5a7a2e0
