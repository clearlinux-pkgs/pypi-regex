...
Source0  : https://files.pythonhosted.org/packages/fb/aa/390071f384435ae3bbda1c30ae8b1ca97575b154694d5ec092bca45d97ef/regex-2022.9.11.tar.gz
...
%prep
%setup -q -n regex-2022.9.11
cd %{_builddir}/regex-2022.9.11
pushd ..
cp -a regex-2022.9.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662998298
