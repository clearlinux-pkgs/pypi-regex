...
Source0  : https://files.pythonhosted.org/packages/7a/db/5ddc89851e9cc003929c3b08b9b88b429459bf9acbf307b4556d51d9e49b/regex-2024.5.15.tar.gz
...
%prep
%setup -q -n regex-2024.5.15
cd %{_builddir}/regex-2024.5.15
pushd ..
cp -a regex-2024.5.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715811648
