...
Source0  : https://files.pythonhosted.org/packages/4c/75/b5b60055897d78882da8bc4c94609067cf531a42726df2e44ce69e8ec7a9/regex-2022.1.18.tar.gz
...
%prep
%setup -q -n regex-2022.1.18
cd %{_builddir}/regex-2022.1.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642607806
...
cp %{_builddir}/regex-2022.1.18/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-regex/692d7ee2ea91449bb8354092cedb2fd1f5a7a2e0
