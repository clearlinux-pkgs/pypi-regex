...
Source0  : https://files.pythonhosted.org/packages/f7/e1/8b46ff54516faea4ea9469c4f5b50f2e9e73131f54d19e6827141698a822/regex-2022.8.17.tar.gz
...
%prep
%setup -q -n regex-2022.8.17
cd %{_builddir}/regex-2022.8.17
pushd ..
cp -a regex-2022.8.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660780575
