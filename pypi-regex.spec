...
Provides: regex
Provides: regex-python
Provides: regex-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641488330
...
cp %{_builddir}/regex-2021.11.10/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-regex/692d7ee2ea91449bb8354092cedb2fd1f5a7a2e0
