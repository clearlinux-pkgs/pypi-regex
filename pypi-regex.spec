...
Source0  : https://files.pythonhosted.org/packages/b5/39/31626e7e75b187fae7f121af3c538a991e725c744ac893cc2cfd70ce2853/regex-2023.12.25.tar.gz
...
%prep
%setup -q -n regex-2023.12.25
cd %{_builddir}/regex-2023.12.25
pushd ..
cp -a regex-2023.12.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703608372
