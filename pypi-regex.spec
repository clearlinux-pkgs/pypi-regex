...
Source0  : https://files.pythonhosted.org/packages/b6/d9/b6971b194833ee2eccf4591f9097833b65e669cce0f8fc0ff2a118238f63/regex-2022.4.24.tar.gz
...
%prep
%setup -q -n regex-2022.4.24
cd %{_builddir}/regex-2022.4.24
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650899653
...
cp %{_builddir}/regex-2022.4.24/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-regex/692d7ee2ea91449bb8354092cedb2fd1f5a7a2e0
