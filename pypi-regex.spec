...
Source0  : https://files.pythonhosted.org/packages/f9/38/148df33b4dbca3bd069b963acab5e0fa1a9dbd6820f8c322d0dd6faeff96/regex-2024.9.11.tar.gz
...
%prep
%setup -q -n regex-2024.9.11
cd %{_builddir}/regex-2024.9.11
pushd ..
cp -a regex-2024.9.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726086225
