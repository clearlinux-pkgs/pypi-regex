...
Source0  : https://files.pythonhosted.org/packages/8e/5f/bd69653fbfb76cf8604468d3b4ec4c403197144c7bfe0e6a5fc9e02a07cb/regex-2024.11.6.tar.gz
...
%prep
%setup -q -n regex-2024.11.6
cd %{_builddir}/regex-2024.11.6
pushd ..
cp -a regex-2024.11.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730929581
